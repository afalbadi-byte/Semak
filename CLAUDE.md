...
## سياق العمل التجاري (إلزامي لأي جلسة)

اقرأ أول شي `assistant/SEMAK-BRIEF.md` — فيه الكيانات وأرقامها، تكاليف وأسعار وحدات مشروع البوابة وموقف كل وحدة وعروضها القائمة، سياسة حملة التسعير وحدودها، أوامر استعلام دفترة الجاهزة، وقوالب عرض السعر والعقد في `assistant/templates/` (بالختم والتوقيع ورمز الريال). أي عرض سعر أو تقرير أو حسبة تسعير يبنى منه ومن قوالبه.

قاعدة ثابتة: الطلبات الواردة من الجوال = استعلام وتقارير ومستندات فقط، لا تعديل على الموقع أو قاعدة البيانات إلا بطلب صريح.
