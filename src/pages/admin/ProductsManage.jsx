      ...
      <div className="animate-fadeIn pb-10" dir="rtl">
        ...
        <div className="bg-white dark:bg-brand-900 rounded-3xl shadow-sm border border-slate-100 dark:border-brand-700 p-6 mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2.5 bg-slate-50 dark:bg-brand-800 hover:bg-slate-100 dark:hover:bg-brand-800 rounded-xl border border-slate-200 dark:border-brand-700 transition"
            >
        ...
        <div className="bg-white dark:bg-brand-900 rounded-3xl shadow-sm border border-slate-100 dark:border-brand-700 p-8 max-w-2xl">
          <div className="space-y-5">
            ...
            {/* الاسم */}
            <div>
              <label className="block text-xs font-bold text-brand-800 dark:text-brand-100 mb-1.5">
            ...
            {/* الكود */}
            <div>
              <label className="block text-xs font-bold text-slate-500 dark:text-brand-400 mb-1.5">
                الكود (اختياري)
              </label>
              <input
                type="text"
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold border transition ${
                      form.unit === u
                        ...
                        : 'bg-slate-50 dark:bg-brand-800/40 text-slate-600 dark:text-brand-300 border-slate-200 dark:border-brand-700 hover:bg-slate-100 dark:hover:bg-brand-800'
                    }`}
                  >
                    {u}
                  </button>
      ...
      <div className="bg-white dark:bg-brand-900 rounded-3xl shadow-sm border border-slate-100 dark:border-brand-700 p-6 mb-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 dark:text-brand-400 font-medium mt-0.5">إدارة كتالوج المنتجات والخدمات في دفترة</p>
          </div>
        </div>
              ...
              <table className="w-full text-right text-sm">
                ...
                <tbody className="divide-y divide-slate-50 dark:divide-brand-700">
                  {tc.pageRows.map((np, idx) => {
                    ...
                    const pid = p.id;
                    return (
                      <tr key={pid || idx} className="hover:bg-slate-50/60 dark:hover:bg-brand-800 transition-colors">
                        ...
                        <td className="px-5 py-3.5 text-slate-600 dark:text-brand-300 text-xs">
