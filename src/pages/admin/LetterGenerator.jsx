...
export default function LetterGenerator() {
  ...
  return (
    <>
      ...
      {/* ========================================================= */}
      <div className="w-full flex flex-col md:flex-row gap-6 font-cairo mb-10 animate-fadeIn min-h-[800px] print:hidden">
        
        {/* اللوحة الجانبية (أدوات التحكم) */}
        <div className="w-full md:w-[350px] bg-[#112240] text-white flex flex-col rounded-[2rem] shadow-xl overflow-hidden">
                ...
                <div className="space-y-3 animate-fadeIn">
                  ...
                  <div>
                    ...
                    <select value={newTempMeta.category} onChange={e => setNewTempMeta({...newTempMeta, category: e.target.value})} className="w-full bg-white/10 rounded-lg p-2 text-sm outline-none border border-white/20 focus:border-teal-500 text-white">
                      ...
                      {/* اختصرت الخيارات هنا للقراءة، احتفظ بخياراتك السابقة إذا أردت */}
                    </select>
                  </div>
                  <div>
                    <label className="text-xs font-bold text-slate-300 block mb-1">اسم النموذج</label>
        ...
        {/* المعاينة المصغرة على الشاشة */}
        <div className="flex-1 bg-slate-200 rounded-[2rem] overflow-y-auto p-4 md:p-8 flex justify-center items-start shadow-inner border border-slate-300">
          <div className="a4-page bg-white text-black shadow-2xl relative overflow-hidden flex flex-col" style={{ width: '210mm', minHeight: '297mm' }}>
            
            {/* الترويسة الوهمية للشاشة */}
            ...
            <div className="font-amiri text-lg relative z-10 flex-grow pt-10 px-12 pb-12">
            ...
            {/* الفوتر الوهمي للشاشة */}
            <div className="mt-auto border-t border-gray-100 bg-gray-50/50 w-full">
      ...
      {/* ========================================================= */}
      {/* 2. نسخة الطباعة (مخفية دائماً، وتظهر فقط عند ضغط Print) */}
      {/* ========================================================= */}
      <div 
        className="hidden print:block font-cairo bg-white text-black" 
        style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact', width: '100%', margin: 0, padding: 0 }}
      >
        <table className="w-full border-collapse">
          ...
          <tfoot className="table-footer-group">
            <tr>
              <td>
                <div className="h-8"></div>
                <div className="border-t-2 border-[#c5a059]/20 bg-slate-50/80 w-full" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                  <div className="text-center py-4 font-cairo">
                    <p className="font-bold text-sm mb-1 text-[#1a365d]">المملكة العربية السعودية - مكة المكرمة - حي البوابة</p>
                    <div className="flex justify-center gap-6 text-xs text-gray-400 ltr" dir="ltr">
                      <span className="font-sans font-bold">semak.sa</span>
