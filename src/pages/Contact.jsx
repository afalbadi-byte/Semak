        ...
        <div className="bg-slate-900/60 backdrop-blur-lg rounded-[3rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-white/10">
          ...
          <div className="lg:w-5/12 p-10 md:p-16 flex flex-col justify-center text-white bg-[#1a365d]/50">
            ...
            <div className="flex flex-wrap gap-4">
              <a href={`https://wa.me/${waPhone}?text=${waMessage}`} target="_blank" rel="noreferrer" title="واتساب" aria-label="واتساب"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <MessageCircle className="text-[#c5a059] group-hover:scale-110 transition-transform" size={22} />
              </a>

              <a href={`tel:${supportPhone}`} title="اتصال مباشر" aria-label="اتصال مباشر"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <Phone className="text-[#c5a059] group-hover:scale-110 transition-transform" size={22} />
              </a>

              <a href="mailto:info@semak.sa" title="البريد الإلكتروني" aria-label="البريد الإلكتروني"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <Mail className="text-[#c5a059] group-hover:scale-110 transition-transform" size={22} />
              </a>

              <a href="https://www.google.com/maps/search/?api=1&query=%D8%AD%D9%8A%20%D8%A7%D9%84%D8%A8%D9%88%D8%A7%D8%A8%D8%A9%D8%8C%20%D9%85%D9%83%D8%A9%20%D8%A7%D9%84%D9%85%D9%83%D8%B1%D9%85%D8%A9" target="_blank" rel="noreferrer" title="الموقع على الخريطة" aria-label="الموقع على الخريطة"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <MapPin className="text-[#c5a059] group-hover:scale-110 transition-transform" size={22} />
              </a>

              <a href="https://www.instagram.com/info.semak" target="_blank" rel="noreferrer" title="انستقرام" aria-label="انستقرام"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <svg viewBox="0 0 24 24" fill="#c5a059" className="w-[22px] h-[22px] group-hover:scale-110 transition-transform">
              ...
              <a href="https://www.facebook.com/semak.sa" target="_blank" rel="noreferrer" title="فيسبوك" aria-label="فيسبوك"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <svg viewBox="0 0 24 24" fill="#c5a059" className="w-[22px] h-[22px] group-hover:scale-110 transition-transform">
              ...
              <a href="https://x.com/semak_sa" target="_blank" rel="noreferrer" title="X (تويتر)" aria-label="X (تويتر)"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <svg viewBox="0 0 24 24" fill="#c5a059" className="w-[22px] h-[22px] group-hover:scale-110 transition-transform">
              ...
              <a href="https://www.linkedin.com/company/semak-realestate" target="_blank" rel="noreferrer" title="لينكدإن" aria-label="لينكدإن"
                className="group w-14 h-14 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#c5a059] rounded-full flex items-center justify-center transition-all">
                <svg viewBox="0 0 24 24" fill="#c5a059" className="w-[22px] h-[22px] group-hover:scale-110 transition-transform">
