            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.facebook.com/semak.sa" target="_blank" rel="noreferrer"
                  className="group flex items-center gap-3 flex-1 bg-white/5 hover:bg-[#1877F2]/20 border border-white/10 hover:border-[#1877F2]/40 p-3 rounded-2xl transition-all duration-300">
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-[#1877F2] shadow-lg group-hover:scale-110 transition-transform flex-shrink-0">
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4">
              ...
              <div className="flex gap-3 mt-3">
                ...
                <a href="https://x.com/semak_sa" target="_blank" rel="noreferrer"
                  className="group flex items-center gap-3 flex-1 bg-white/5 hover:bg-white/15 border border-white/10 hover:border-white/30 p-3 rounded-2xl transition-all duration-300">
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-black shadow-lg group-hover:scale-110 transition-transform flex-shrink-0">
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4">
                ...
                <a href="https://www.linkedin.com/company/semak-realestate" target="_blank" rel="noreferrer"
                  className="group flex items-center gap-3 flex-1 bg-white/5 hover:bg-[#0A66C2]/20 border border-white/10 hover:border-[#0A66C2]/40 p-3 rounded-2xl transition-all duration-300">
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-[#0A66C2] shadow-lg group-hover:scale-110 transition-transform flex-shrink-0">
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4">
