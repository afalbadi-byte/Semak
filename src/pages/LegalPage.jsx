  ...
  return (
    <div className="pt-32 pb-20 bg-slate-50 dark:bg-brand-900/40 min-h-screen animate-fadeIn">
      <div className="container mx-auto px-6 max-w-4xl text-right">
        <div className="bg-white dark:bg-brand-900 p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100 dark:border-brand-700 relative overflow-hidden">

          {/* زخرفة خلفية */}
          <div className="absolute top-0 left-0 w-full h-2 bg-gold-500" />
          <div className="absolute top-0 left-0 w-64 h-64 bg-gold-500/5 rounded-br-full pointer-events-none -z-0" />

          {/* رأس الصفحة */}
          <div className="flex justify-between items-center mb-10 relative z-10 border-b border-slate-100 dark:border-brand-700 pb-6">
            <h1 className="text-3xl md:text-4xl font-black text-brand-800 dark:text-brand-100 flex items-center gap-3">
              {title === "سياسة الخصوصية" ? <Shield className="text-gold-500" size={36} /> : <Scale className="text-gold-500" size={36} />}
              {title}
            </h1>
            <button onClick={() => navigateTo ? navigateTo("home") : navigate("/")} className="text-slate-400 dark:text-brand-400 hover:text-gold-500 bg-slate-50 dark:bg-brand-800 hover:bg-orange-50 dark:hover:bg-brand-800 p-3 rounded-full transition">
              <ArrowRight size={24} />
            </button>
          </div>

          {/* المحتوى */}
          <div className="prose prose-lg text-slate-600 dark:text-brand-300 space-y-8 relative z-10 font-medium leading-loose">
            
            {title === "سياسة الخصوصية" && (
              <>
                <p className="text-lg font-bold text-brand-800 dark:text-brand-100">
                  نحرص في <span className="text-gold-500">سماك العقارية</span> على حماية خصوصية بيانات عملائنا وزوار موقعنا الإلكتروني. توضح هذه السياسة كيفية جمعنا للمعلومات، واستخدامها، وحمايتها.
                </p>

                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">1. البيانات التي نجمعها</h3>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">2. كيف نستخدم معلوماتك؟</h3>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">3. حماية ومشاركة البيانات</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">4. حقوق المستخدم</h3>
                  <p>
                ...
                <div className="bg-blue-50 dark:bg-blue-500/15 p-6 rounded-2xl border border-blue-100 dark:border-blue-500/30">
            ...
            {title === "الشروط والأحكام" && (
              <>
                <p className="text-lg font-bold text-brand-800 dark:text-brand-100">
                  مرحباً بك في الموقع الإلكتروني لشركة <span className="text-gold-500">سماك العقارية</span>. بوصولك واستخدامك لهذا الموقع، فإنك توافق على الالتزام بالشروط والأحكام التالية:
                </p>

                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">1. استخدام الموقع</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">2. الملكية الفكرية</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">3. دقة المعلومات العقارية</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">4. بوابة الملاك وطلبات الصيانة</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-black text-brand-800 dark:text-brand-100 mb-3">5. القانون المطبق</h3>
                  <p>
