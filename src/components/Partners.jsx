  ...
  return (
    <div className="py-10 bg-white border-t border-slate-100 overflow-hidden no-print" id="partners-section">
      <div className="container mx-auto text-center mb-8">
        <h2 className="text-gold-500 font-black tracking-[0.3em] text-sm mb-2">شركاء النجاح</h2>
        <h3 className="text-2xl md:text-3xl font-black text-brand-800">نختار الأفضل لبناء منزلك</h3>
      </div>
