            ...
            <div className="rounded-2xl border border-paper-2 bg-paper-card p-3 space-y-2.5">
                ...
                {stage === 'live' ? (
                    <>
                        ...
                        {info ? <p className="text-[10.5px] text-ink-3/70 text-center">الميكروفون {Math.round(info.rate / 1000)} ألف · {info.gpu ? 'مسرَّع' : 'برمجي'} · شدّة {(info.level * 1000).toFixed(1)}</p> : null}
