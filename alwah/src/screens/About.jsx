        ...
        <div className="space-y-5 pb-6">
            ...
            <Section title="المصادر">
                <Card className="p-4 space-y-2.5 text-[13px] leading-7 text-ink-2">
                    ...
                    <p><b className="text-ink">الإعراب:</b> «الجدول في إعراب القرآن وصرفه وبيانه» لمحمود بن عبد الرحيم صافي، يُجلب عند الطلب عبر الباحث القرآني (tafsir.app) ولا يُخزَّن في التطبيق، ويُعرض نصّه كما هو. وقد يعرب الكتاب آياتٍ متتابعةً معاً، فيُبيَّن مدى ما يغطّيه.</p>
                    <p><b className="text-ink">سبب النزول:</b> «الصحيح المسند من أسباب النزول» للشيخ مقبل بن هادي الوادعي رحمه الله، وقد اقتصر فيه على ما صحّ إسناده. ويُعرض نصّ الرواية بتخريجها ورقم صفحتها في المطبوع. وإن لم يكن للآية موضعٌ في الكتاب، عُرض ما صرّح به المفسّرون في الكتب الثلاثة أعلاه، وإلا قيل: لم يُذكر سبب نزول.</p>
