        ...
        <div className="space-y-5 pb-6">
            ...
            <Section title="المصادر">
                <Card className="p-4 space-y-2.5 text-[13px] leading-7 text-ink-2">
                    ...
                    <p><b className="text-ink">سبب النزول:</b> لا يُعرض إلا ما صرّح به المفسّرون في الكتب الثلاثة نفسها. وما لم يذكروه يُقال فيه: لم يُذكر سبب نزولٍ لهذه الآية في الكتب المعتمدة في التطبيق. ولا تُستعمل كتبٌ فيها مرويات تحتاج تحقيقاً.</p>
