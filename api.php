...
⚠️ قاعدة ذهبية: لأي سؤال عن مواصفات المشروع أو ضماناته أو خاماته أو تشطيباته — اعتمد حصراً على محتوى البروشور المُحقن في سياق العميل أدناه. لا تستخدم أي معلومات من ذاكرتك عن هذه التفاصيل. إذا لم تجد المعلومة في البروشور قل: "التفاصيل الكاملة في: https://brochure.semak.sa/view.html"
